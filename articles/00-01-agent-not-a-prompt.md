...
![モデル、ループ、ツール、状態で Agent が構成され、外部 Harness が制御システムを提供することを示す](/images/00-01-agent-not-a-prompt/abb6330313ea-photo-00-agent-runtime-composition.png)
...
![Prompt、ChatBot、Agent、Harness の責任がどのように段階的に増えるかを説明する](/images/00-01-agent-not-a-prompt/5db61124a907-photo-01-prompt-to-agent-evolution.png)
...
![Agent の基本定義：なぜ一文の Prompt ではないのか？ Mermaid 1](/images/00-01-agent-not-a-prompt/c49589353017-mermaid-01.png)
...
![単発回答と複数ターンの前進の違いを閉ループとして描き、状態と観測結果の回流を強調する](/images/00-01-agent-not-a-prompt/a7b61e83549b-photo-02-agent-loop-reality-bridge.png)
...
![Agent の基本定義：なぜ一文の Prompt ではないのか？ Mermaid 2](/images/00-01-agent-not-a-prompt/1fe198c4428a-mermaid-02.png)

この図の矢印方向に注意してください。モデルはツールを直接呼びませんし、状態を直接書きません。すべての外部アクションは Runtime を通ります。この分担はこの先も何度も出てきます。

同じ鎖を状態遷移図として描くこともできます。

![Agent の基本定義：なぜ一文の Prompt ではないのか？ Mermaid 3](/images/00-01-agent-not-a-prompt/349f450d1f94-mermaid-03.png)
...
![モデルの提案は権限、サンドボックス、ログ、検証を通ってから現実世界へ入る必要があることを示す](/images/00-01-agent-not-a-prompt/036dcb39a7c0-photo-03-control-system-catches-action.png)
...
![Agent の基本定義：なぜ一文の Prompt ではないのか？ Mermaid 4](/images/00-01-agent-not-a-prompt/179ebe7738c1-mermaid-04.png)
