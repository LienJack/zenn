...
![01. エンジニアリングアーキテクチャ 図1：Model API の外側にあるエンジニアリングシェル](/images/01-engineering-architecture/6d2f8dc742ba-01-photo-01-engineering-shell.png)

## 2. 機能アーキテクチャ：Claude Code にはどのような能力層があるか？
![](/images/01-engineering-architecture/9a58ae7cb960-02-photo-05.png)
...
![01.工程架构 図 1](/images/01-engineering-architecture/82c4b15d9817-01-engineering-architecture-mermaid-01.png)
...
![01.エンジニアリングアーキテクチャ 手書き図2：Claude Code の能力レイヤー](/images/01-engineering-architecture/58c275ed4766-01-photo-02-capability-layers.png)
...
![01.工程架构 スケッチ図 3：用户输入在运行时里的流动](/images/01-engineering-architecture/8a078f1d9c4b-01-photo-03-runtime-flow.png)

シーケンス図で表すと：

![01.工程架构 図 2](/images/01-engineering-architecture/ac9e3b017793-01-engineering-architecture-mermaid-02.png)
...
![01.工程架构 スケッチ図 4：源码阅读的承重链路](/images/01-engineering-architecture/266d8498a1fb-01-photo-04-code-load-bearing-chain.png)

つまり、この節はディレクトリ一覧を示すのではなく、後続の記事群のためにソースコード上の座標を定めるものだ。

まずは以下の図で全体像を掴んでほしい。

![01.工程架构 図 3](/images/01-engineering-architecture/be605b3ab17e-01-engineering-architecture-mermaid-03.png)
